...
public class Stopwords
  ...
  private void add(String string) {
	...
	this.m_Words.add(string.trim().toLowerCase());
	
  }
  
  public void addExplicitly(String path) throws IOException{
		...
		while ((sCurrentLine = br.readLine()) != null) {
			...
			{
				this.m_Words.add(words[i].trim().toLowerCase());
			}
		}
  }
  ...
  public String removeStopWords(String input){
	  ...
	  {
		  //System.out.println(words[i]);
		  if(!this.m_Words.contains(words[i])){
